...
Research Track: Financial Statement Analysis and Project Valuation  
...
Research Track: Quantitative Finance and Asset Pricing  
...
Coordinated and negotiated with investment banks’ DCM and FICC teams throughout debt issuance processes  
...
**Languages:**  
Spanish (Native), English (Advanced: TOEFL 620 / IBT 102), Portuguese (Advanced), French (Intermediate: DELF B1), Chinese (Beginner: HSK3)

**Technical:**  
Microsoft Office (Advanced), VBA (Basic), Stata (Intermediate), Python (Intermediate), R (Intermediate), LaTeX (Intermediate), SQL (Basic), Power BI (Basic)
